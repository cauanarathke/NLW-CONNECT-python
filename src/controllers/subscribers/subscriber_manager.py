...
from src.model.repositories.interfaces.subscribers_repository import SubscribersRepositoryInsterface

class subscriberManager:
    def __init__(self, subscribers_repo: SubscribersRepositoryInsterface):
    ...
    def get_event_ranking(self, http_request: HttpRequest) -> HttpResponse:
        ...
        return self.__format_event_rankking(event_ranking)
    ...
    def __format_event_rankking(self, event_ranking: list) -> HttpResponse:
            formatted_event_ranking = []
            for posicao in event_ranking:
                formatted_event_ranking.append(
                    {
                        "link": posicao.link,
                        "total_subscribers": posicao.total
                    }
                )
            return HttpResponse(
                body={
